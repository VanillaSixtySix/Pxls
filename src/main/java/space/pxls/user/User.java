...
public class User {
    ...
    public boolean canPlaceColor(int color) {
        return color >= 0 && (color < App.getPalette().getColors().size() || (color == 0xFF && placementOverrides.getCanPlaceAnyColor())) && (App.getPalette().getColors().get(color).getUsable() || placementOverrides.getCanPlaceAnyColor());
    }
